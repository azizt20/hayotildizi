    ...
    <div class="flex lg:justify-between flex-col-reverse lg:flex-row">
      <div class="w-full lg:w-1/2">
        ...
        <div class="mt-6 lg:mt-16 flex items-center space-x-6">
          <btn :to="localePath(`/products/${products[0].id}`)">{{ $t("buy") }}</btn>
          <btn :to="localePath(`/products/${products[0].id}`)" outline>{{ $t("more") }}</btn>
        </div>
      </div>
  ...
  >
    <div class="flex lg:justify-between flex-col lg:flex-row">
      ...
      <div class="w-full lg:w-1/2 lg:ml-10">
        ...
        <div class="mt-6 lg:mt-16 flex items-center space-x-6">
          <btn :to="localePath(`/products/${products[1].id}`)">{{ $t("buy") }}</btn>
          <btn :to="localePath(`/products/${products[1].id}`)" outline>{{ $t("more") }}</btn>
        </div>
      </div>
    </div>
  </section>
